"""
╔══════════════════════════════════════════════════════════════════════╗
║      Enterprise Seat Optimisation  —  Production v8.0               ║
║      Windfall Power  |  Multi-Plant Seat Reallocation                ║
║      REAL-ESTATE OPTIMISATION EDITION                                ║
╚══════════════════════════════════════════════════════════════════════╝
...
OUTPUT_FILE = "optimized_seat_allocation_v82.xlsx"
...
SEP = "=" * 64
print(f"\n{SEP}")
print("  Enterprise Seat Optimisation  --  Production v8.0  [Real-Estate Edition]")
print(f"{SEP}\n")
