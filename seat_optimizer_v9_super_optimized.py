...
W_LARGE_FLOOR_EVAC     = 800_000
W_LARGE_FLOOR_PRIORITY  = 300_000  # NEW: prioritize bigger floors
...
def run_greedy():
    ...
    def evac_priority(e):
        # NEW: prioritize larger floors first
        floor_size = floor_seat_capacity.get((e_bldg[e], e_floor[e]), 0)
